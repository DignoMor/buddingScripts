from buddingScripts import script_generator
from buddingScripts.exceptions import cli_input_error
...
def main():
    # setting up parsers
    parser = argparse.ArgumentParser('buddingScripts')
    with open(os.path.join(Path.home(), '.buddingScriptsRC.json'), 'r') as f:
        settings = json.load(f)

    subcommandParsers = parser.add_subparsers(title="buddingScripts",
                                            dest="subcommand", )
